...
function mergeSameDateEntry(previous, next) {
  ...
  return {
    ...
    added_count: Number(previous.added_count || 0) + Number(next.added_count || 0),
    changed_count: Number(previous.changed_count || 0) + Number(next.changed_count || 0),
    removed_count: Number(previous.removed_count || 0) + Number(next.removed_count || 0),
    watched_count: Number(previous.watched_count || 0) + Number(next.watched_count || 0),
