...
const WORK_RULES = [
  ...
  { title: "Mobile Suit Gundam 00", universe: "AD", pattern: /ガンダム00(?![0-9])|ダブルオー|エクシア|デュナメス|キュリオス|ヴァーチェ|ナドレ|アストレア|ケルディム|アリオス|セラヴィー|セラフィム|オーライザー|トランザムライザー|クアンタ|ジンクス|ティエレン|スサノオ|フラッグ|GN-|スローネ|アルケー|アヘッド|イナクト|ガデッサ|ガラッゾ|マスラオ|リボーンズ|ハルート|サバーニャ|ラファエル|ブレイヴ|1\.5|アイズ|オーガンダム|ガッデス|GNアーチャー/i },
