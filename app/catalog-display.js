...
export const GRADE_SHORT_LABELS = {
  ...
  POKE_MONCOLLE: { zh: "モンコレ", ko: "몬컬", en: "Moncolle", ja: "モンコレ" },
  POKE_KUJI: { zh: "一番赏", ko: "이치방쿠지", en: "Ichiban Kuji", ja: "一番くじ" },
  POKE_PRIZE: { zh: "景品", ko: "프라이즈", en: "Prize", ja: "景品" },
  POKE_FIGURE: { zh: "手办", ko: "피규어", en: "Figure", ja: "フィギュア" },
