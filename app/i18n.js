...
export const TRANSLATIONS = {
  zh: {
    ...
    accountCodeSent: "验证码已发送，请查收邮箱（几分钟内有效）。",
  ...
  ko: {
    ...
    accountCodeSent: "인증번호를 보냈어요. 메일함을 확인해 주세요.",
  ...
  en: {
    ...
    accountCodeSent: "Code sent. Check your inbox.",
  ...
  ja: {
    ...
    accountCodeSent: "認証コードを送信しました。メールをご確認ください。",
